...
pub fn ConversationHistory() -> impl IntoView {
    ...
    let conversations = vec![
        Conversation {
            id: "1".to_string(),
            title: "Discussione su Rust".to_string(),
            messages: vec![],
            last_message: js_sys::Date::now() - 3600000.0, // 1 hour ago
        },
        Conversation {
            id: "2".to_string(),
            title: "Implementazione UI Leptos".to_string(),
            messages: vec![],
            last_message: js_sys::Date::now() - 7200000.0, // 2 hours ago
        },
        Conversation {
            id: "3".to_string(),
            title: "Configurazione Tailwind".to_string(),
            messages: vec![],
    ...
    view! {
        <div class="flex-1 overflow-y-auto custom-scrollbar">
            <div class="p-4">
                <h3 class="text-sm font-medium text-base-content/70 mb-3">"Conversazioni recenti"</h3>
                <div class="space-y-1">
                    <For
                            ...
                            view! {
                                <button class="btn btn-ghost w-full justify-start text-left p-2 h-auto min-h-0 hover:bg-base-300 transition-colors duration-200 animate-slide-in">
                                    <div class="flex flex-col items-start w-full">
                                        ...
                                        <span class="text-xs opacity-60">"2 ore fa"</span>
                                    </div>
                                </button>
                            }
                        }
